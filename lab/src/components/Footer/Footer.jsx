...
const Footer = () =>
  ...
  <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
    <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul>
                    <li>
                        <a href="https://www.linkedin.com/in/rod-raymond-281a0284/" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Rod Raymond</a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/michaelabebe5/" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Michael Abebe</a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/banner-samuelson/" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Banner Samuelson</a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/galinakishirova/" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Galina Kishirova</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" target="_blank" className="hover:underline">L.A.G.A</a>. All Rights Reserved.
        </span>
